...
public class MIDLParser extends Parser {
	...
	public static final int
		...
		ID=39, INTEGER_TYPE_SUFFIX=40, INTEGER=41, EXPONENT=42, FLOAT_TYPE_SUFFIX=43, 
		FLOATING_PT=44, ESCAPE_SEQUENCE=45, CHAR=46, STRING=47, BOOLEAN=48, WS=49;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "ID", "INTEGER_TYPE_SUFFIX", "INTEGER", "EXPONENT", 
			"FLOAT_TYPE_SUFFIX", "FLOATING_PT", "ESCAPE_SEQUENCE", "CHAR", "STRING", 
			"BOOLEAN", "WS"
		};
	}
	...
	public static class DefineTypeContext extends DefinitionContext {
		public Type_declContext type_decl() {
			return getRuleContext(Type_declContext.class,0);
		}
		public DefineTypeContext(DefinitionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitDefineType(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class DefineModuleContext extends DefinitionContext {
		public ModuleContext module() {
			return getRuleContext(ModuleContext.class,0);
		}
		public DefineModuleContext(DefinitionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitDefineModule(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final DefinitionContext definition() throws RecognitionException {
		...
		try {
			...
			case T__4:
				...
				break;
			case T__1:
				_localctx = new DefineModuleContext(_localctx);
	...
	public static class StructDefineContext extends Type_declContext {
		public Struct_typeContext struct_type() {
			return getRuleContext(Struct_typeContext.class,0);
		}
		public StructDefineContext(Type_declContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitStructDefine(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class StructDeclContext extends Type_declContext {
		public TerminalNode ID() { return getToken(MIDLParser.ID, 0); }
		public StructDeclContext(Type_declContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitStructDecl(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Type_declContext type_decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				_localctx = new StructDefineContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(79);
				struct_type();
	...
	public static class TypeBaseTypeSpecContext extends Type_specContext {
		public Base_type_specContext base_type_spec() {
			return getRuleContext(Base_type_specContext.class,0);
		}
		public TypeBaseTypeSpecContext(Type_specContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitTypeBaseTypeSpec(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class TypeStructTypeContext extends Type_specContext {
		public Struct_typeContext struct_type() {
			return getRuleContext(Struct_typeContext.class,0);
		}
		public TypeStructTypeContext(Type_specContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitTypeStructType(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class TypeScopeNameContext extends Type_specContext {
		public Scoped_nameContext scoped_name() {
			return getRuleContext(Scoped_nameContext.class,0);
		}
		public TypeScopeNameContext(Type_specContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitTypeScopeName(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Type_specContext type_spec() throws RecognitionException {
		...
		try {
			...
			case T__5:
			case ID:
				_localctx = new TypeScopeNameContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(99);
				scoped_name();
			...
			case T__21:
			case T__22:
				_localctx = new TypeBaseTypeSpecContext(_localctx);
				enterOuterAlt(_localctx, 2);
				{
				setState(100);
				base_type_spec();
				...
				break;
			case T__4:
				_localctx = new TypeStructTypeContext(_localctx);
	...
	public static class TypeFloatContext extends Base_type_specContext {
		public Floating_pt_typeContext floating_pt_type() {
			return getRuleContext(Floating_pt_typeContext.class,0);
		}
		public TypeFloatContext(Base_type_specContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitTypeFloat(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class TypeCharContext extends Base_type_specContext {
		public TypeCharContext(Base_type_specContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitTypeChar(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class TypeBoolContext extends Base_type_specContext {
		public TypeBoolContext(Base_type_specContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitTypeBool(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class TypeIntContext extends Base_type_specContext {
		public Integer_typeContext integer_type() {
			return getRuleContext(Integer_typeContext.class,0);
		}
		public TypeIntContext(Base_type_specContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitTypeInt(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class TypeStringContext extends Base_type_specContext {
		public TypeStringContext(Base_type_specContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MIDLVisitor ) return ((MIDLVisitor<? extends T>)visitor).visitTypeString(this);
			else return visitor.visitChildren(this);
		}
	}
